...
import com.enation.javashop.android.component.order.databinding.OrderCreateGroupItemLayBinding
 ...
 * @Note   订单Item适配器
 */
class OrderCreatePromotionAdapter(var data : String) : BaseDelegateAdapter<BaseRecyclerViewHolder<OrderCreateGroupItemLayBinding>,String>() {
     ...
     * @Note   创建ViewHolder
     */
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): BaseRecyclerViewHolder<OrderCreateGroupItemLayBinding> {
        return BaseRecyclerViewHolder.build(parent, R.layout.order_create_group_item_lay)
    }
     ...
     * @Note   绑定ViewHolder
     */
    override fun onBindViewHolder(holder: BaseRecyclerViewHolder<OrderCreateGroupItemLayBinding>?, position: Int) {
        holder?.bind {
            binding ->
